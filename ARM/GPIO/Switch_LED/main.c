...
#define DIP_SW_D0 (1 << 16)		// P0.16 ;8-way DIP switches connected to Port0 pin 16 to 25
...
#define DIP_SW_DIR		IO1DIR // special function register to set_dipswitch_port_input the direction
#define DIP_SW_PIN		IO1PIN  // special function register to read_dip_switch data 
